...
class EnergiDataserviceX:
    ...
    def Retrieve_sql_dataset_from_server(self, query: object) -> object:
        ...
        print("Get:", uri + query)
        print(uri + urllib.parse.quote(query.strip()))
        fileobj: object = urllib.request.urlopen(uri + urllib.parse.quote(query.translate(str.maketrans('', '', string.whitespace))))
        result_dict = json.loads(fileobj.read())
        return result_dict
